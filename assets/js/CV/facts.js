(function () {
    ...
    const introSection = document.getElementById("cv-intro");
    const factsDrawer = document.querySelector(".cv-facts-drawer");
    const factsPanel = document.querySelector(".cv-facts-panel");
    const factsToggle = document.querySelector(".cv-facts-toggle");
    const metaWrap = document.querySelector(".cv-facts-meta");
    ...
    if (!factsDrawer || !factsPanel || !factsToggle || !metaWrap) {
        return;
    }
    ...
    const updateFactsScrollShift = () => {
        ...
        const toggleWidth = factsToggle.getBoundingClientRect().width || 56;
        const panelWidth = factsPanel.getBoundingClientRect().width || 320;
    ...
    const initFloatingCards = () => {
        ...
        if ("IntersectionObserver" in window) {
            const observerTarget = introSection || factsDrawer;
    ...
    try {
        ...
        console.error("CV facts bubbles failed to initialize", error);
    }
})();
