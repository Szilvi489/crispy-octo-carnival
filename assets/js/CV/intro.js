(function () {
    ...
    const metaWrap = section.querySelector(".cv-intro-meta");
    const metaCards = metaWrap ? Array.from(metaWrap.querySelectorAll(".cv-intro-meta-card")) : [];
